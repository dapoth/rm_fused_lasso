...
%\includegraphics[width=\textwidth]{../../bld/out/figures/cgh_plot_beta.pdf}
%\includegraphics[width=\textwidth]{../../bld/out/figures/cgh_plot_raw.pdf}
...
\includegraphics[width=\textwidth]{../../bld/out/figures/plot_solutionpath_lasso.pdf}
\includegraphics[width=\textwidth]{../../bld/out/figures/plot_solutionpath_fused_lasso.pdf}
...
This property of the lasso estimator is special since other regularization methods do not set some of the estimated coefficients exactly to zero. This makes the lasso a useful tool for model selection. This is especially helpful in the high-dimensional setting. For example the ols estimator is known to have low bias but very high variance. In a lot of cases the mean squared error would be lower if one were to introduce a small amount of bias but therefore decrease the variance by a large amount. One way of doing it is by using the lasso estimator. Other methods for model selection as backward selection cannot be applied any more  and other methods as for example best subset selection become computationally infeasible for large $p$. \\
...
\includegraphics[width=\textwidth]{../../bld/out/figures/signal_lasso_plot.pdf}
...
The fused lasso estimator is biased. The adaptive lasso was in part propsed to eliminate the bias in the lasso estimate. One could think of a similar procedure for the fused lasso case, where in the first stage we apply the fused-lasso estimator to the objective function. In the second stage we apply the fused lasso estimator on the same problem exept that this time we weight the coefficients with the estimates from the first estimation.
\subsection{Solution methods}
...
\begin{figure}
	\includegraphics[width=\textwidth]{../../bld/out/figures/heatmap_blocks_few_spikes.png}
	\caption{Heatmap}
\end{figure}
...
\begin{figure}
		\includegraphics[width=\textwidth]{../../bld/out/figures/plot_fused}
		\caption{Estimators}
\end{figure}
