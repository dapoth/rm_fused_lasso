...
\includegraphics[width=\textwidth]{../../bld/out/figures/outfile}
...
\begin{figure}
	\centering		\includegraphics[width=0.7\textwidth]{../../src/sandbox/figures/plot_fused}
...
\begin{table}
	\centering
	\scriptsize
	\input{../../src/sandbox/figures/mytable.tex}
	%\input{mytable.tex}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{../../src/sandbox/figures/lasso_penalty}
...
\begin{figure}
	\centering
	\includegraphics[width=.7\textwidth]{../../src/sandbox/figures/plot_solutionpath_lasso}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{../../src/sandbox/figures/plot_solutionpath_fused_lasso}
