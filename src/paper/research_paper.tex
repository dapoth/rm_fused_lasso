...
\bigskip
\noindent The proof of this theorem can be found in the appendix. Convexity of the solution set can be helpful when one has calculated the lasso solution for two different penalty terms. Then ...
...
\bigskip
\todo{Brauchen wir diesen Abschnitt?}
...
The fused lasso is therefore a soft thresholded version of the fusion estimator. This fact can be exploited, when analyzing for example the asymptotics.
\bigskip
