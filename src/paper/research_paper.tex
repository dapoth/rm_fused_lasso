...
\begin{figure}
	\centering		\includegraphics[width=0.7\textwidth]{../../out/figures/plot_fused.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{../../out/figures/Geogebra/lasso_penalty}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth]{../../out/figures/Geogebra/fused_and_lasso_penalty}
