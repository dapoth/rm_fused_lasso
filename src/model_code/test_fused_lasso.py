...
def test_lasso_signal_dual(setup_param_lasso, expected_beta):
    """Docstring."""
    expected_beta_lasso_signal = expected_beta["values_signal"]["expected_beta_"
                                                                "lasso"]
...
def test_lasso_general_dual(setup_param_lasso, expected_beta):
    ...
    expected_beta_lasso_general = expected_beta["values_general"]['expected_'
                                                                  'beta_lasso']
    calculated_beta_dual = fused_lasso_dual(**setup_param_lasso["data_dual"])
...
def test_lasso_general_primal(setup_param_lasso, expected_beta):
    ...
    expected_beta_lasso_general = expected_beta["values_general"]['expected_bet'
                                                                  'a_lasso']
...
def test_fused_lasso_signal_dual(setup_param_fused_lasso, expected_beta):
    """Docstring."""
    expected_beta_fused_lasso_signal = expected_beta["values_signal"]['expected'
                                                                      '_beta_'
                                                                      'fused_'
                                                                      'lasso']
...
def test_fused_lasso_general_dual(setup_param_fused_lasso, expected_beta):
    """Docstring."""
    expected_beta_fused_lasso_general = expected_beta["values_general"]['expected'
                                                                        '_beta'
                                                                        '_fused_'
                                                                        'lasso']
    setup_param_fused_lasso["data_dual"]['X'] = np.array([[1, 0.5, 0], [0, 1,
                                                         0.5], [0.5, 0, 1]])
    calculated_beta_dual = fused_lasso_dual(**setup_param_fused_lasso["data_dua"
                                                                      "l"])
